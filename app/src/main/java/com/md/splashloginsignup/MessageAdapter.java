...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder> {
    ...
    private List<Messages> UserMessageList;// list that will hold our messages from messages class
    private DatabaseReference userRef;
    private FirebaseAuth mAuth;

    public MessageAdapter (List<Messages> UserMessageList)
    {
        this.UserMessageList=UserMessageList;// helps us to add the view in it
    }
...
//Gets the sender of this message
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    String receiverprofileimage=dataSnapshot.child("profile_images").getValue().toString();
    ...
    public int getItemCount() {
        return UserMessageList.size();//returns The number of items currently available in adapter
    }
